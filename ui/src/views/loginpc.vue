...
<script>
  // import {demo} from '../../static/js/demo-1.js' //注意路径
  ...
  export default {
    ...
    mounted() {
      ...
      var goto = "https://oapi.dingtalk.com/connect/oauth2/sns_authorize?appid=dingoagzpnxuezq1lukowt&response_type=code&scope=snsapi_login&state=STATE"+
        "&redirect_uri=http://10.0.1.157:8080/";
      var qrcodeUrl = "https://login.dingtalk.com/login/qrcode.htm?goto="+encodeURIComponent(goto);
      var obj = DDLogin({
        id:"login_container",
        qrcodeUrl: "https://login.dingtalk.com/login/qrcode.htm?goto="+encodeURIComponent(goto),
        style: "",
        href: "",
        width : "300px",
        height: "300px",
    ...
    //
      hanndleMessage (event) {
        ...
        if (origin == "https://login.dingtalk.com" || origin == "https://pre-login.dingtalk.com" ) {
          window.location.href = this.getUrlParam("goto", qrcodeUrl) + "&loginTmpCode=" + data;
        }
      },
